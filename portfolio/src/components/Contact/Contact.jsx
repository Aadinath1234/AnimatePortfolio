...
//       <div className="flex flex-row max-sm:flex-col max-lg:flex-col max-lg:ml-4 px-40 max-sm:w-74 max-sm:p-4 py-4 bg-orange-50">
...
//           </svg>
//           <input
//             type="text" // Changed to text instead of 'input'
//             required
//             placeholder="Username"
//             pattern="[A-Za-z][A-Za-z0-9\-]*"
//             minLength="3" // Corrected 'minlength' to 'minLength'
//             maxLength="30" // Corrected 'maxlength' to 'maxLength'
...
//               <svg
//                 className="h-[1em] opacity-50 w-20"
//                 xmlns="http://www.w3.org/2000/svg"
//                 viewBox="0 0 24 24"
//               >
//                 <g
...
//         <input type="text" placeholder="Subject" className="input w-4/5 max-lg:w-4/5" />
//         <textarea
//           placeholder="Message"
//           className="textarea textarea-md w-4/5 p-20 h-4/5"
//         ></textarea>

//         <button className="btn btn-primary w-40 ">Send Message </button>
//       </div>
